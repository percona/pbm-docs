...
# -*- coding: utf-8 -*-
#
# Percona Backup for MongoDB documentation build configuration file, created by
# sphinx-quickstart on Tue Apr  2 15:22:57 2019.
#
...
latex_documents = [
  ('index', # source start file
   #target name, such as PerconaBackupForMongoDB-5.7.tex
   '.'.join(['-'.join([''.join(project.split()), version]), 'tex']), 
   ' '.join([project, 'Documentation']), # title, such as Percona Backup for MongoDB Documentation
   copyright, 
...
# the title page.
#
latex_logo = '_images/Percona_Logo_Color.png'
...
man_pages = [('index', # source start file
              ...
              ' '.join([project, version, u'Documentation']), # description, such as Percona Backup for MongoDB 1.2 Documentation
              [copyright], # authors
              1 # manual section
)]
