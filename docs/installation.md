x# Installing Percona Backup for MongoDB
...
:material-numeric-3-circle: **Install Percona Backup for MongoDB** 
...
:material-numeric-2-circle: **Go to the project directory and build it**
...
:material-numeric-1-circle: **Fetch the binary tarball**
...
:material-numeric-2-circle: **Extract the tarball**

  ```sh
  tar -xf percona-backup-mongodb-<version>-x86_64.tar.gz
  ```

:material-numeric-2-circle: **Export the location of the binaries to the `PATH` variable**
