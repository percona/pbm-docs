...
Defines whether to use HTTP or HTTPS protocol when accessing the server. Default: `false`.
...
### storage.minio.credentials.secret-access-key-id
...
### storage.minio.credentials.signature-version
