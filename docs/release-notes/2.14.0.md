...
- [PBM-1703](https://perconadev.atlassian.net/browse/PBM-1703): Previously, Percona Backup for MongoDB (PBM) could generate repeated 404 error messages in S3 storage related to .pbm.init.pbmpart.1 objects. While these messages did not affect backup integrity, they cluttered logs and consumed storage space. PBM now suppresses these redundant error messages, resulting in cleaner S3 logs and more efficient storage usage during backup initialization.
