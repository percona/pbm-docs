...
- [PBM-1294](https://perconadev.atlassian.net/browse/PBM-1294): Percona Backup for MongoDB already supports selective backups of databases and collections. Now, the selective backup can also include users and roles defined within the database.
