...
- [PBM-1687](https://perconadev.atlassian.net/browse/PBM-1687): Fixed an issue where backups were incorrectly marked as incompatible when an invalid MONGODB_URI was configured.