...
:material-numeric-1-circle: **Install `percona-release`**
...
:material-numeric-2-circle: **Enable the repository**
...
=== "On Debian and Ubuntu Linux"
    ...
    :material-numeric-1-circle: **Stop `pbm-agent`**

      ```sh
      sudo systemctl stop pbm-agent
      ```

    :material-numeric-2-circle: **Install new packages**

      ```sh
      sudo apt install percona-backup-mongodb
      ```  

    :material-numeric-3-circle: **Reload the `systemd` process**
...
=== "On Debian and Ubuntu Linux"
    ...
    :material-numeric-1-circle: **List available versions**
    ...
    :material-numeric-2-circle: **Stop `pbm-agent`**:

       ```sh
       sudo systemctl stop pbm-agent
       ```

    :material-numeric-3-circle: **Install packages**
